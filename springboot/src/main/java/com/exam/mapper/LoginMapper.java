...
//    public Admin adminLogin(Integer username, String password);
    ...
    @Select("select adminId,adminName,sex,tel,email,cardId,role from admin where email = #{email} and pwd = #{password}")
...
//    public Teacher teacherLogin(Integer username, String password);
    ...
    @Select("select teacherId,teacherName,institute,sex,tel,email,cardId," +
            "type,role from teacher where email = #{email} and pwd = #{password}")
...
//    public Student studentLogin(Integer username,String password);
    ...
    @Select("select studentId,studentName,grade,major,clazz,institute,tel," +
            "email,cardId,sex,role from student where email = #{email} and pwd = #{password}")
