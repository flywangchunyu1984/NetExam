...
<template>
  <div class="all">
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="sex" label="性別" width="120"></el-table-column>
      <el-table-column prop="email" label="メール" width="120"></el-table-column>
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <el-button @click="checkGrade(scope.row.studentId)" type="primary" size="small">編集</el-button>
          <el-button @click="deleteById(scope.row.studentId)" type="danger" size="small">削除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
