...
<template>
  <div class="exam">
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="description" label="コメント" width="200"></el-table-column>
      ...
      <el-table-column prop="tips" label="コメント" width="400"></el-table-column>
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <el-button @click="add(scope.row.paperId,scope.row.source)" type="primary" size="small">登録</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
