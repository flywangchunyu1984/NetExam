<template>
  <div class="score">
    <div class="title">
      <p class="name">セキュリティ研修テスト</p>
      <p class="description">(満点：100点)</p>
    </div>
    <div class="total">
      <div class="look">
        試験結果
...
>>>>>>> refs/heads/saika
      ...
      <ul class="time">
        <li class="start"><span>開始時刻</span> <span>{{startTime}}</span></li>
        <li class="end"><span>終了時刻</span> <span>{{endTime}}</span></li>
      </ul>
    </div>
  </div>
</template>
